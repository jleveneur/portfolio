  ...
  return (
    <section className="grid max-w-6xl gap-4 sm:grid-cols-12">
      <div className="col-span-12 sm:col-span-3">
        <div className="before:mb-5 before:block before:h-3 before:w-24 before:rounded-md before:dark:bg-primary">
      ...
      <div className="relative col-span-12 space-y-6 sm:col-span-9 sm:px-4">
        <div className="relative space-y-12 before:dark:bg-gray-300 sm:space-y-8 sm:px-4 sm:before:absolute sm:before:-left-3 sm:before:bottom-0 sm:before:top-2 sm:before:w-0.5">
